  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col gap-3">
      ...
      <a
        ...
        className="group h-12 w-12 rounded-full border border-foreground/30 bg-background/80 backdrop-blur text-foreground flex items-center justify-center shadow-sm hover:scale-105 transition-transform"
      >
